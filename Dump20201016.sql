...
--
-- Table structure for table `partizipatu`
--

DROP TABLE IF EXISTS `partizipatu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `partizipatu` (
  `herrialdea` varchar(45) NOT NULL,
  `noiz` date NOT NULL,
  `erantzuna` varchar(45) NOT NULL,
  PRIMARY KEY (`herrialdea`,`noiz`),
  KEY `fk_partizipatu_2_idx` (`noiz`),
  CONSTRAINT `fk_partizipatu_1` FOREIGN KEY (`herrialdea`) REFERENCES `herrialdea` (`izena`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_partizipatu_2` FOREIGN KEY (`noiz`) REFERENCES `noiz` (`noiz`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `partizipatu`
--

LOCK TABLES `partizipatu` WRITE;
/*!40000 ALTER TABLE `partizipatu` DISABLE KEYS */;
/*!40000 ALTER TABLE `partizipatu` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-10-16  6:54:54
